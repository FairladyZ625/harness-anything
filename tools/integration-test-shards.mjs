...
// with significant drift refreshed from successful main run 31371466475.
...
export const integrationTestFileWeightsMs = Object.freeze({
  ...
  "packages/application/test/task-lifecycle-transition-atomicity.test.ts": 18594,
  ...
  "packages/cli/test/attribution-diff-cli.test.ts": 12097,
  "packages/cli/test/authority-indeterminate-receipt-honesty.test.ts": 18320,
  "packages/cli/test/authority-repo-enrollment.integration.test.ts": 15131,
  "packages/cli/test/cas-gc-daemon-cli.test.ts": 6917,
  "packages/cli/test/check-governance-cli.test.ts": 93300,
  "packages/cli/test/check-scope-cli.test.ts": 25772,
  "packages/cli/test/coldstart-p1-cli.test.ts": 25585,
  "packages/cli/test/complete-final-step-deadzone.test.ts": 238277,
  "packages/cli/test/completion-cli.test.ts": 6445,
  ...
  "packages/cli/test/daemon-autostart-root-lifetime.test.ts": 10703,
  "packages/cli/test/daemon-autostart-startup-diagnostics.test.ts": 19226,
  ...
  "packages/cli/test/daemon-log-input-validation.test.ts": 6446,
  "packages/cli/test/daemon-refresh-preflight.test.ts": 97460,
  "packages/cli/test/daemon-service-startup-diagnostics.test.ts": 19200,
  "packages/cli/test/daemon-snapshot-integration.test.ts": 92898,
  ...
  "packages/cli/test/decision-consent-health-cli.test.ts": 7485,
  "packages/cli/test/decision-projection-warning-cli.test.ts": 9448,
  "packages/cli/test/decision-surface-admission-cli.test.ts": 10369,
  ...
  "packages/cli/test/doc-sync-cli.test.ts": 82094,
  "packages/cli/test/doctor-cli.test.ts": 56645,
  ...
  "packages/cli/test/graph-cli.test.ts": 11999,
  ...
  "packages/cli/test/lifecycle-recovery-shape-matrix-cli.test.ts": 67702,
  "packages/cli/test/ledger-p0-regression.test.ts": 11297,
  ...
  "packages/cli/test/p16-command-parity-cli.test.ts": 33332,
  "packages/cli/test/post-merge-check-cli.test.ts": 47500,
  "packages/cli/test/production-authority-canonical-ingress-tracer.test.ts": 64121,
  "packages/cli/test/production-authority-in-review-submit.test.ts": 17814,
  ...
  "packages/cli/test/preset-create-milestone-cli.test.ts": 9493,
  ...
  "packages/cli/test/preset-github-issue-repair-cli.test.ts": 7937,
  ...
  "packages/cli/test/perf/cli-latency-budget.test.ts": 37620,
  ...
  "packages/cli/test/task-lineage-preset-decoupling-cli.test.ts": 23781,
  "packages/cli/test/task-plan-admission-cli.test.ts": 24066,
  ...
  "packages/cli/test/unknown-option-cli.test.ts": 10285,
  ...
  "packages/cli/test/repo-write-child-production-cutover.test.ts": 17644,
  "packages/daemon/test/daemon-autostart-recovery.test.ts": 6279,
  "packages/daemon/test/daemon-writer-reader-cutover.test.ts": 32411,
  "packages/daemon/test/repo-write-child-process-transport.test.ts": 7502,
  "packages/daemon/test/repo-write-process-supervisor.test.ts": 24764,
  "packages/daemon/test/task-complete-prepublish-witness.test.ts": 8926,
  ...
  "packages/kernel/test/store/projection-source-cache-warm-start.test.ts": 6379,
