...
const expectedPackages = new Map([
  ...
  ["packages/api-contracts/package.json", "@harness-anything/api-contracts"],
  ["packages/daemon-client/package.json", "@harness-anything/daemon-client"],
  ["packages/vscode-ext/package.json", "harness-anything-vscode"],
...
for (const relativePath of [
  ...
  "packages/cli/.git",
  "packages/gui/.git",
  "packages/api-contracts/.git",
  "packages/daemon-client/.git",
  "packages/vscode-ext/.git",
