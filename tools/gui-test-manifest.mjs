export const guiVitestManifest = [
  ...
  "packages/gui/test/task-review-write-consume.vitest.ts",
  "packages/gui/test/task-progress-write-consume.vitest.ts",
  "packages/gui/test/trace-session-disabled.vitest.ts",
