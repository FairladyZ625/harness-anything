...
if (rootPackage.dependencies?.effect !== "3.22.0") record("effect version must remain 3.22.0 after task_01KYYGC7B9J97PRA32A9BSAXSM");
if (cliPackage.dependencies?.["@effect/platform"] !== "0.97.0") record("@effect/platform version must remain 0.97.0 after task_01KYYGC7B9J97PRA32A9BSAXSM");
