 ...
 * 可寻址导航。Token 消耗不在本页:系统 Tab 的「Token 消耗」页与会话详情消耗面板
 * (P1.3)是唯一消耗视图,attempts 上的度量字段仍经 repo.squad.run.read 暴露。
 */
...
/** 总 Token 开销看板已随 P1.3 交付形态调整撤销:消耗视图收敛到系统 Tab 的「Token 消耗」
 * 页与会话详情消耗面板,不在小队编排详情重复一套。 */
