...
export type GuiActionResult = DaemonGuiActionResult; export type GuiBridgeMethod = (typeof import("../../../daemon/src/protocol/daemon-protocol.contract.ts").daemonGuiReadMethods)[number]["guiBridgeMethod"] | (typeof import("../../../daemon/src/protocol/daemon-protocol.contract.ts").daemonGuiActionMethods)[number]["guiBridgeMethod"] | (typeof import("../../../daemon/src/protocol/daemon-protocol.contract.ts").daemonGuiStreamFacets)[number]["guiBridgeMethod"] | "listRuntimeInstances" | "showRuntimeInstance" | "createRuntimeInstance" | "deleteRuntimeInstance" | "validateRuntimeInstanceAuth" | "signInRuntimeInstance" | "reauthRuntimeInstance" | "signOutRuntimeInstance";
