...
type Kind = "claude" | "codex"; type CreatePayload = { readonly instanceId: string; readonly name: string; readonly kindId: Kind; readonly installationId: string; readonly providerId: string; readonly model: string; readonly claude?: { readonly baseUrl?: string }; readonly codex?: { readonly reasoningEffort?: string; readonly baseUrl?: string }; readonly authMode: "subscription" | "api-key" }; type Receipt = Readonly<Record<string, unknown>>;
