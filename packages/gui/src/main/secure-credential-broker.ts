...
type Kind = "claude" | "codex" | "agy"; type CreatePayload = { readonly instanceId: string; readonly name: string; readonly kindId: Kind; readonly installationId: string; readonly providerId: string; readonly model: string; readonly claude?: { readonly baseUrl?: string }; readonly codex?: { readonly reasoningEffort?: string; readonly baseUrl?: string; readonly wireApi?: string; readonly requiresOpenAiAuth?: boolean; readonly httpHeaders?: Readonly<Record<string, string>> }; readonly agy?: { readonly effort?: "low" | "medium" | "high" }; readonly authMode: "subscription" | "api-key"; readonly apiKey?: string }; type Receipt = Readonly<Record<string, unknown>>;
