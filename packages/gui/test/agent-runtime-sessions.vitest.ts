...
const squadRunDetail = {
  squadRunId: squadRunSummary.squadRunId,
  squadId: squadRunSummary.squadId,
  taskId: squadRunSummary.taskId,
  mission: squadRunSummary.mission,
  phase: "converged" as const,
  revision: 9,
  currentLeaderRuntimeSessionId: null,
  leaderRuntimeSessionIds: ["runtime-leader-6"],
  leaders: [
    {
      turnId: "turn-6",
      trigger: {},
  ...
  workers: [
    ...
    { attemptId: "w-4", workerId: "sol", dispatchId: null, runtimeSessionId: null, rejection: "no runtime available" },
  ],
  workerCallbackCount: 5,
