...
describe("provider planes (2026-08-20 adjudication)", () => {
  ...
  it("creates and shows detected or explicitly selected models through the renderer bridge and daemon store", async () => {
    ...
    try {
      ...
      vi.stubGlobal("window", { harness: { listRuntimeInstances: unavailable, showRuntimeInstance, createRuntimeInstance, updateRuntimeInstance: unavailable, deleteRuntimeInstance: unavailable, signInRuntimeInstance: unavailable, signOutRuntimeInstance: unavailable } });
