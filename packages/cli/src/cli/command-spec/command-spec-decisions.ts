...
export const decisionsCommandSpecs = defineCommandSpecs([
  ...
  {
    "kind": "decision-amend",
    "usage": "decision amend <decision-id> [--title <title>] [--load-bearing <claim-id>|--non-load-bearing <claim-id>] [--set <field>:<value>] [--append <field>:<json>] [--body <text>|--body-file <path>] [--dry-run] [--json]",
