...
export const decisionsCommandSpecs = defineCommandSpecs([
  ...
  {
    "kind": "decision-amend",
    "usage": "decision amend <decision-id> [--title <title>] [--standing-policy] [--fulfillment <claim-id>:<mode>]... [--load-bearing <claim-id>|--non-load-bearing <claim-id>] [--set <field>:<value>] [--append <field>:<json>] [--dry-run] [--json]",
    "options": [{"flag":"--title","description":"Set the required task title used for generated package metadata and slug."},{"flag":"--standing-policy","description":"Classify the decision as a standing policy."},{"flag":"--fulfillment","description":"Declare one claim fulfillment mode as claim-id:evidenced, claim-id:delivered, or claim-id:standing-policy."},{"flag":"--load-bearing","description":"Mark an existing claim as covered by the reckon gate during decision amend."},{"flag":"--non-load-bearing","description":"Mark the proposed primary claim, or an existing amended claim, as exempt from reckon coverage."},{"flag":"--set","description":"Replace a schema-declared amendable field value."},{"flag":"--append","description":"Append a JSON value to a schema-declared amendable field."},{"flag":"--dry-run","description":"Preview the operation without writing changes."},{"flag":"--json","description":"Emit command-receipt/v2 JSON."}],
