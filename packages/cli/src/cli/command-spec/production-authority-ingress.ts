...
const dispositions = {
  ...
  "task-closeout": excluded("CLI compatibility facade dispatches one task-complete command and reuses the typed completion transaction, so it does not require a second canonical ingress"),
