...
export const runtimeDocsCommandSpecs = defineCommandSpecs([
  ...
  {
    "kind": "task-list",
    "usage": "task list [--state <state>] [--module <key>] [--queue <queue>] [--preset <id>] [--kind feat|fix|refactor|docs|test|chore] [--risk-tier low|medium|high] [--urgency low|medium|high] [--tree-root <task-id>] [--parent <task-id>] [--liveness in_flight|stale] [--review <state>] [--lesson [present|missing]] [--missing-materials] [--include-archived] [--search <text>] [--json]",
    "options": [{"flag":"--state","description":"Filter task packages by task state: planned, active, blocked, in_review, done, or cancelled."},{"flag":"--module","description":"Select a registered module key; use module list to discover keys."},{"flag":"--queue","description":"Filter by queue."},{"flag":"--preset","description":"Select a preset id; task create defaults to standard-task and preset list shows installed presets."},{"flag":"--kind","description":"Filter task packages by work kind: feat, fix, refactor, docs, test, or chore."},{"flag":"--risk-tier","description":"Filter task packages by risk tier: low, medium, or high."},{"flag":"--urgency","description":"Filter task packages by urgency: low, medium, or high."},{"flag":"--taskClass","description":"Filter by the bundled software/coding taskClass field extension."},{"flag":"--tree-root","description":"Filter to the selected task and its descendant closure."},{"flag":"--parent","description":"Filter to direct children of the selected task."},{"flag":"--liveness","description":"Filter by derived task liveness: in_flight or stale."},{"flag":"--review","description":"Filter by review state."},{"flag":"--lesson","description":"Filter by lesson state."},{"flag":"--missing-materials","description":"Filter tasks missing required materials."},{"flag":"--include-archived","description":"Include archived task packages."},{"flag":"--search","description":"Search task metadata and prose."},{"flag":"--json","description":"Emit command-receipt/v2 JSON."}],
