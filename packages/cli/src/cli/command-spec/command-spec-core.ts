...
export const coreCommandSpecs = defineCommandSpecs([
  ...
  },
  {
    ...
    "summary": "Evaluate the Task's resolved preset/profile completionGates. Completion always requires exactly one submitted Execution, no active Execution rounds, and an approved typed Review; legacy review.md is only a compatibility blocker check. Use not-applicable only when the contract declares no CI obligation; Facts are never a quantity gate (dec_mrg3z1we/CH4; ADR-0027 D5-D7).",
