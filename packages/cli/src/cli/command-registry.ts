...
const commandUsages = [
  ...
  { kind: "task-amend", usage: "task amend <id> --set <field>:<value> [--json]" },
  ...
  { kind: "migrate-anchors", usage: "migrate anchors [--dry-run|--apply] [--json]", aliases: [deprecatedAlias("migrate-anchors", "migrate anchors")] },
...
const commandSummaries = {
  ...
  "task-amend": "Amend vertical-declared task field extensions without changing lifecycle state.",
  ...
  "migrate-anchors": "Backfill missing required template anchors into existing task documents.",
...
const commandExamples = {
  ...
  "task-amend": [`${cliCommandName} task amend task_01ABC --set taskClass:milestone`],
  ...
  "migrate-anchors": [`${cliCommandName} migrate anchors --dry-run --json`],
