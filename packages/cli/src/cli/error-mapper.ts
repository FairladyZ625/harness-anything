...
const cliErrorMappers = {
  ...
  RelatedTaskHardDeleteForbidden: (error) => cliError(CliErrorCode.RelatedTaskHardDeleteForbidden, `Task ${error.taskId} has task relations; remove or supersede relations before hard delete.`),
