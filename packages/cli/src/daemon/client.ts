...
// not to the resident daemon that owns the shared socket. Exported so callers
// that must spawn the daemon host entry themselves (tools/soak) strip the same set.
