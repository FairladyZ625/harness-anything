...
export function renderDaemonHelp(): string {
  return [
    ...
    "",
    "Primary workflow:",
    "  1. ha daemon repo register --root .",
    "  2. ha daemon start --service",
    "  3. ha daemon status --json",
    "  Inspect a step with: ha daemon <subcommand> --help",
    "",
    "Common commands:",
    ...
    "  restart [options]            Restart the service and wait for a replacement PID.",
