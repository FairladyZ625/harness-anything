...
export const taskWriteCliRoutePolicies = [
  ...
  { actionKind: "task-code-doc-reconcile", leaseRequired: false, commandClass: "repo-write" },
  ...
  { actionKind: "task-retire-execution", leaseRequired: false, commandClass: "repo-write" },
