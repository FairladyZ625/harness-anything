import { serializeCanonicalEvent, type CanonicalEventStore, type DecisionEventV1, type DecisionProjectionRow, type DecisionSearchFilters, type FactEventV1, type FactProjectionRow, type FactSearchFilters, type TaskProjection } from "../../kernel/src/index.ts";
