      ...
      input: {
        ...
        fields: [
          ...
          },
          {
            ...
            type: "boolean",
            required: false,
            cli: { name: "--example", kind: "boolean", error: "invalid_field" },
          },
          {
            field: "fromCloseout",
            type: "boolean",
            required: false,
            cli: { name: "--from-closeout", kind: "boolean", error: "invalid_field" },
          },
          {
            field: "pr",
            type: "number",
            required: false,
            cli: { projection: "number", name: "--pr", kind: "single", error: "invalid_field" },
          },
