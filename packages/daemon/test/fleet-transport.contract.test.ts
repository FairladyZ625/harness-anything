...
const frames = [
  ...
  { schema: "fleet.doc.submit/v1", messageId: "m10", assignmentId: "a1", executionId: null, baseLedgerSha: "a".repeat(40), changes: [{ path: "tasks/task/a.md", baseBlobSha256: null, policyId: "markdown-body-replaceable/v1", candidate: { ref: "doc-sync-claims/u1", ...blob } }] },
  ...
  { schema: "fleet.task.command/v1", messageId: "m22-task", assignmentId: "a1", opId: "op-task-1", repoId: "repo", taskId: "task_abc", action: { kind: "task-start", taskId: "task_abc", ttlMs: 86_400_000 }, waitMs: 30_000, docChanges: null, mirrorBaseCut: null },
