...
test("GUI action facets are exact, typed, and exclude the generic runner", () => {
  ...
  const cases = new Map<string, Record<string, unknown>>([
    ...
    ["repo.entity.update", { entityKind: "entity-kind/KND-1f5c0a7e9b3d4c6a8e2f0b1d3c5a7e94", entityId: "ADR-abc", expectedVersion: 7, title: "Updated", locator: "harness/adr/ADR-0002.md", contentVersion: "git:abc" }],
