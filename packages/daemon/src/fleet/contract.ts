...
export type FleetFrameV1 =
  ...
  | Msg<"fleet.doc.submit/v1", { assignmentId: string; executionId: string | null; baseLedgerSha: string; changes: readonly FleetDocChange[] }>
  ...
  | Msg<"fleet.task.command/v1", { assignmentId: string; opId: string; repoId: string; taskId: string | null; action: FleetTaskAction; waitMs: number; docChanges: readonly FleetDocChange[] | null; mirrorBaseCut: FleetMirrorBaseCut | null }>
