...
export type FleetFrameV1 =
  ...
  | Msg<"fleet.task.command/v1", { assignmentId: string; opId: string; repoId: string; taskId: string | null; action: FleetTaskAction; waitMs: number; docChanges: readonly FleetDocChange[] | null; mirrorBaseCut: number | null }>
