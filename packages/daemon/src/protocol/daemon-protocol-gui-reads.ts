...
export const daemonGuiReadMethods = Object.freeze([
  ...
  },
  {
    ...
    requiresRepo: true,
    params: shape({ repo: shape({ repoId: "string" }) }),
    guiBridgeMethod: "listSchedules",
    httpMethod: "GET",
    path: "/api/schedules",
    inputSchemaId: "gui.empty/v1",
    outputSchemaId: DAEMON_SCHEDULES_LIST_SCHEMA.id,
    errorSchemaId: DAEMON_PROTOCOL_ERROR_SCHEMA.id,
  ...
  },
  {
    ...
    params: shape({
      repo: shape({ repoId: "string" }),
      payload: shape({ scheduleId: "string", limit: "number?" }),
    }),
    guiBridgeMethod: "listScheduleRuns",
    httpMethod: "GET",
    path: "/api/schedules/:scheduleId/runs",
    inputSchemaId: "gui.schedule-runs-query/v1",
    outputSchemaId: DAEMON_SCHEDULE_RUNS_SCHEMA.id,
    errorSchemaId: DAEMON_PROTOCOL_ERROR_SCHEMA.id,
    serviceMethod: "listScheduleRuns",
    auth: "local-session-token",
    commandClass: "repo-read",
  },
  {
