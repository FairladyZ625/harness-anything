...
export const daemonGuiActionMethods = Object.freeze([
  ...
  guiAction(
    ...
    shape({
      ...
      executionId: "string",
      reviewId: "string",
      verdict: { values: ["approved", "changes_requested", "dismissed"], optional: false },
      reason: "string",
  ...
  guiAction(
    ...
    "repo.task.consent",
    "task-review-consent",
    shape({ taskId: "string", executionId: "string", reviewId: "string", consentId: "string" }),
    "consentTaskReview",
  ...
  guiAction(
    ...
    "repo.task.complete",
    "task-complete",
    shape({ taskId: "string", executionId: "string", ci: "string?" }),
    "completeTask",
