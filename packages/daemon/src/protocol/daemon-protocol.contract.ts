...
} from "./daemon-protocol-gui-actions.ts";
...
/* Runtime instance method descriptors live in the browser-safe protocol graph. */
export { daemonGuiInvokeFacets, runtimeInstanceAuthMethods, runtimeInstanceMethods };
