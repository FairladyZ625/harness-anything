...
export const runtimeKinds = [
  ...
  },
  {
    ...
    defaultProviderId: "droid",
    executable: {
      command: "droid",
      configDirectory: ".factory",
      configHomeEnvironment: null,
      authFile: null,
      modelProbe: null,
      modelProbeFormat: "json-models",
  ...
  },
  {
    ...
    defaultProviderId: "qwen-code",
    executable: {
      command: "qwen",
      configDirectory: ".qwen-code",
      configHomeEnvironment: null,
      authFile: null,
      modelProbe: null,
      modelProbeFormat: "json-models",
  ...
  },
  {
    ...
    defaultProviderId: "minimax-code",
    executable: {
      command: "mcode",
      configDirectory: ".minimax-code",
      configHomeEnvironment: null,
      authFile: null,
      modelProbe: null,
      modelProbeFormat: "json-models",
  ...
  },
  {
    ...
    defaultProviderId: "mistral-vibe",
    executable: {
      command: "vibe-acp",
      configDirectory: ".vibe",
      configHomeEnvironment: null,
      authFile: null,
      modelProbe: null,
      modelProbeFormat: "json-models",
  ...
  },
  {
    ...
    protocolFamily: "acp",
    displayName: "Junie",
    defaultProviderId: "junie",
    executable: {
      command: "junie",
      configDirectory: ".junie",
      configHomeEnvironment: null,
      authFile: null,
      modelProbe: null,
      modelProbeFormat: "json-models",
  ...
  },
  {
    ...
    protocolFamily: "acp",
    displayName: "GLM (ACP)",
    defaultProviderId: "glm-acp",
    executable: {
      command: "glm-acp-agent",
      configDirectory: ".glm-acp-agent",
      configHomeEnvironment: null,
      authFile: null,
      modelProbe: null,
      modelProbeFormat: "json-models",
