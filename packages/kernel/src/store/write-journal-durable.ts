...
import type { JournalRecord, LockTakeoverRecord, PayloadRef, WriteWatermark } from "./write-journal-types.ts";
...
export function appendJsonLineDurably(filePath: string, value: JournalRecord | LockTakeoverRecord | Record<string, unknown>): void {
