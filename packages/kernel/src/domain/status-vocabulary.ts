...
export const statusVocabularies: readonly StatusVocabulary[] = [
  ...
  { id: "decision.state", entity: "Decision", field: "state", module: "packages/kernel/src/domain/decision-event.ts", anchor: "decisionStates", words: ["proposed", "in_effect", "rejected", "deferred", "superseded", "outcome_retired"] },
  { id: "decision.judgment.target", entity: "Decision", field: "judgment targetState", module: "packages/kernel/src/domain/decision-event.ts", anchor: "#targetState", words: ["in_effect", "rejected", "deferred"], subsetOf: "decision.state", note: "Consent target states of the three judgment actions." },
