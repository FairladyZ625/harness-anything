...
export type OpaqueTextualMediaType = "application/json" | "application/yaml" | "text/css" | "text/csv" | "text/html" | "text/javascript" | typeof OPAQUE_TEXTUAL_MEDIA_TYPE;
...
export function classifyTextualArtifactPath(value: string): TextualArtifactClassification | null {
  ...
  return artifactPath(value) ? { kind: "opaque-textual", mediaType: opaqueTextualMediaType(value), policyId: OPAQUE_TEXTUAL_POLICY_ID } : null;
}

export function isOpaqueTextualMediaType(value: unknown): value is OpaqueTextualMediaType {
  return value === "application/json" || value === "application/yaml" || value === "text/css" || value === "text/csv" || value === "text/html" || value === "text/javascript" || value === OPAQUE_TEXTUAL_MEDIA_TYPE;
}
