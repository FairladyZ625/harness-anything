...
export const runtimeAndRecoveryStatusWords: readonly StatusWordRegistration[] =
  [
    // ---- RuntimeSession.liveness / outcome ----
    {
      ...
      resolution:
        "Heartbeat liveness, unrelated to FactRecord.live; stored in runtime events — CH2 proposal only.",
    },
    {
      word: "stale",
      entity: "RuntimeSession",
    ...
    },
    {
      ...
      meaning:
        "The provider transcript can be retrieved by its session identifier.",
      divergence: "entity-scoped",
    },
    {
      ...
      field: "transcript reachability",
      meaning:
        "The transcript is available only from the temporary dispatch stream.",
      divergence: "entity-scoped",
    },
    {
      word: "unavailable",
      ...
      field: "transcript reachability",
      meaning:
        "No provider session identifier or dispatch transcript is available.",
      divergence: "entity-scoped",
    },
    ...
    },
    {
      ...
      field: "outcome",
      meaning:
        "Publication outcome could not be determined; query the receipt before retrying.",
      divergence: "entity-scoped",
    },
    {
      word: "op_rejected",
      ...
      divergence: "divergent",
      resolution:
        "Same operation-result family as PresetRun.op_rejected; renamed from rejected at the CH3 cutover so the one-shot operation result no longer collides with Decision.rejected.",
    },
    ...
    },
    {
      ...
      field: "state",
      meaning:
        "Recovery batch exhausted its current budget with items remaining.",
      divergence: "entity-scoped",
    },
    {
      word: "failed",
