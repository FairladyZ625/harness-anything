...
export function repositorySettingsActionValues(settings: RepositorySettingsV1): {
  readonly [field: string]: string | number | boolean | readonly string[];
} {
  const closeoutGate = (gate: keyof NonNullable<RepositorySettingsV1["closeout"]["overrides"]>) =>
