...
export { decideDocWrite, isDocEvent, resolveDocRoute, validateDocWriteIntent } from "./domain/doc-sync.contract.ts";
export type { DocEventV1, DocWriteIntent } from "./domain/doc-sync.contract.ts";
