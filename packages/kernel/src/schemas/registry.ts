...
import { HarnessConfigSchema } from "./harness-config.ts";
...
export { HarnessConfigSchema } from "./harness-config.ts";
...
export const SqliteTaskRowSchema = Schema.Struct({
  ...
  liveness: Schema.NullOr(Schema.Literal("in_flight", "stale")),
