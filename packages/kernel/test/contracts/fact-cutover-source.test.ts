...
test("Fact product code limits facts.md to machine bootstrap and typed routing", () => {
  ...
  assert.deepEqual(mentions, ["packages/kernel/src/domain/doc-sync.contract.ts", "packages/preset/src/preset-bootstrap.ts"]);
