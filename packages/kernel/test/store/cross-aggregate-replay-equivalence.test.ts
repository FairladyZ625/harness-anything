...
test("warm event projection and cold coverage adapter agree on the same replay inputs", () => {
  ...
  try {
    ...
    db.prepare("INSERT INTO decision_claim VALUES ('dec_EQ','C0','Undeclared fulfillment stays uncovered',1,NULL,1,NULL),('dec_EQ','C1','Evidence must be live',1,'evidenced',1,NULL),('dec_EQ','C2','Delivery must be done',1,'delivered',1,NULL)").run();
