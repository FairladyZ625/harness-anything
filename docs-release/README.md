...
After version 0.0.1 is published to npm, install the scoped CLI with:
...
Until that package exists, use the source checkout path above or install the
locally packed scoped CLI.
