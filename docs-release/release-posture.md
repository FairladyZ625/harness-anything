...
| ------------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Source CLI write path                             | Shipped      | The thin CLI parses, transports, and renders only. Its contracted task lifecycle writes go through the explicitly started resident daemon; it has no autostart or local fallback. Evidence: `packages/cli/src/cli/thin-command.ts`.                                                                                                                                                                                                                 |
